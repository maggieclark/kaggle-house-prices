...
# mean of imputed medians with minimally processed data: 0.167349
mean(metrics)
...
######### train_cleaned_option2.csv with extra nhood vars ###############################
...
# mean of missing as factor level with feature engineered data: 0.1480007
mean(metrics)
