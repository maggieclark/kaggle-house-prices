...
import pandas as pd
from feature_eng_2 import nhood_medians_df
...
# merge neighborhood medians generated from training data
data_eng = data_eng.merge(nhood_medians_df, how='left', on='Neighborhood')
data_eng = data_eng.rename(columns={"SalePrice": "nhood_median_price"})
...
# write
data_eng.to_csv('test_cleaned.csv')
